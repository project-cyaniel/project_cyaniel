...
Revision ID: d4d9fabc9d02
Revises: 
Create Date: 2017-04-06 09:39:32.064511
...
def upgrade():
    ...
    sa.Column('description', sa.String(length=200), nullable=True),
    sa.Column('last_update', sa.DateTime(), nullable=True),
    sa.Column('att_type_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['att_type_id'], ['attribute_types.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('character_att_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['character_att_id'], ['attributes.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['attribute_id'], ['character_attributes.id'], ),
